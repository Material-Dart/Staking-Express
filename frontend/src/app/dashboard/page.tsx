...
export default function Dashboard() {
    ...
    const handleStake = async () => {
        ...
        // Implementation pending `stake` method in useStaking hook or here
    };

    const handleUnstake = async () => {
        console.log("Unstaking:", amount);
        // Implementation pending `unstake` method in useStaking hook or here
    };

    const handleClaim = async () => {
        console.log("Claiming Rewards");
        // Implementation pending `claim` method
    };
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                    ...
                    <div className="bg-slate-800/40 p-6 rounded-2xl border border-white/5 hover:border-indigo-500/30 transition-all group">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <button onClick={handleClaim} className="text-xs text-purple-400 hover:text-purple-300 font-semibold uppercase tracking-wide">
                                Talep Et
                            </button>
                        </div>
                    </div>
                                ...
                                <div>
                                    <div className="flex justify-between text-sm mb-2">
                                        ...
                                        <span className="text-gray-400">
                                            Mevcut: <span className="text-white font-mono">
                                                {activeTab === "stake" ? "0.00" /* Needs wallet balance */ : staking.userStaked.toFixed(2)}
                                            </span>
                                        </span>
                                    </div>
                                    <div className="relative">
                                        ...
                                        <button
                                            ...
                                            onClick={() => setAmount(activeTab === "unstake" ? staking.userStaked.toString() : "")}
                                        >
                                            MAX
                                        </button>
                                    </div>
                                    ...
                                    <tbody className="divide-y divide-white/5">
                                        ...
                                        <tr className="text-center">
                                            <td colSpan={3} className="py-4 text-xs text-gray-500 italic">
                                                Gerçek veriler yakında eklenecek...
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
